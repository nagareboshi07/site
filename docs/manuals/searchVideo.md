...
### 最新バージョン
- ver.2.20V  
  ※原則、最新バージョンを使用してください。<br>

### サポート中バージョン（不具合対応のみ）
- なし<br>
### サポート終了バージョン
- ver.2.11V以前のver.2.xx系（2023/12/31 サポート終了）<br>
  ※API仕様変更（ssl接続必須）に伴い、ver.2.20Vに更新を行いました。<br>
  　そのため、ver.2.11V以前はサポートを終了いたします。<br>
  　ただし、Patch1の適用を実施した製品はサポート対象外ですが、使用可能です。<br>
  　（本パッチは、23/12/31時点で稼働中のナガレボシ管理対象のシートのみ適用しております。）<br>
